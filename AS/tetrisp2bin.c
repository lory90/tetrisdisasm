...
void printUsage() { printf("usage: tetrisp2bin.exe inputcodefile.p outputromfile.bin sharefile.h\n"); }
...
//		printf("arg %d is %s\n", i, argv[i]);
	...
	{
		printf("\ntetrisp2bin.exe: generating %s from %s", romFileName, codeFileName);
